...
String urlupdate = "https://ahmedbawazir.com/flutter/php/edit_job.php";
...
class EditBook extends StatefulWidget {
  ...
  const EditBook({Key key, this.user}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            title: Text('REQUEST HELP EDIT BOOK'),
...
class _CreateNewbookState extends State<CreateNewbook> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Text('Click on image above to take book picture'),
        SingleChildScrollView(
          ...
          child: Row(
            children: <Widget>[
              ...
              new IconButton(
                  iconSize: 40, icon: new Icon(Icons.code), onPressed: null),
              new IconButton(
                  iconSize: 40,
                  icon: new Icon(Icons.directions_bike),
                  onPressed: null),
  ...
  void _changebook() {
    _bookcontroller.text = "Runner";
  }

  void _changeFood() {
    _bookcontroller.text = "Order Food";
  }

  void _programer() {
    _bookcontroller.text = "Programmer";
  }
